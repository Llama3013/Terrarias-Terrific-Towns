...
export function getNPCBackground(multiBiome, multiBiomeSetting) {
  if (multiBiome.biomeSwitch && multiBiomeSetting) {
    return multiBiome.type === "Corruption"
      ? "url(" + CorruptBack + ")"
      : multiBiome.type === "Crimson"
      ? "url(" + CrimBack + ")"
      : multiBiome.type === "Desert"
      ? "url(" + DesertBack + ")"
      : multiBiome.type === "Dungeon"
      ? "url(" + DungeonBack + ")"
      : multiBiome.type === "Forest"
      ? "url(" + ForestBack + ")"
      : multiBiome.type === "Mushroom"
      ? "url(" + MushroomBack + ")"
      : multiBiome.type === "Hallow"
      ? "url(" + HallowBack + ")"
      : multiBiome.type === "Jungle"
      ? "url(" + JungleBack + ")"
      : multiBiome.type === "Ocean"
      ? "url(" + OceanBack + ")"
      : multiBiome.type === "Snow"
      ? "url(" + SnowBack + ")"
      : multiBiome.type === "Underground"
      ? "url(" + UnderBack + ")"
      : "none";
  } else {
    return "none";
